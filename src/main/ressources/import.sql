...
--Conseiller
INSERT INTO `gestibankbd`.`user` (`USER_TYPE`, `id`, `address`, `dateOfBirth`, `email`, `firstName`, `lastName`, `password`, `phonenumber`, `numeroclient`, `contratStartingDate`, `fonction`, `matricule`) VALUES ('Conseiller', '13', '45 rue du Four, 69017, le Cannet', '1919-07-15 00:00:00', 'pollet.sarah@mail.com', 'Pollet', 'Sarah', 'sarah', '0609786496', NULL, '2016-05-12 00:00:00', NULL, 'C964879'); 
INSERT INTO `gestibankbd`.`user` (`USER_TYPE`, `id`, `address`, `dateOfBirth`, `email`, `firstName`, `lastName`, `password`, `phonenumber`, `numeroclient`, `contratStartingDate`, `fonction`, `matricule`) VALUES ('Conseiller', '12', '45 rue du Four, 69017, le Cannet', '1919-07-15 00:00:00', 'jusforgues.quentin@mail.com', 'Jusforgues', 'Quentin', 'quentin', '0609786496', NULL, '2016-05-12 00:00:00', NULL, 'C875496');
